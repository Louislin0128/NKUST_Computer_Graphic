...
void display() {
	...
	switch (view_mode) {
	case 0:
		//glOrtho(-1.0, +1.0, 0.0, 7.0, 0.0, 1.0);
		//glFrustum(GLdouble left, GLdouble Right, GLdouble bottom, GLdouble top, GLdouble near, GLdouble far); 透視投影
		glFrustum(-0.5, +0.5, 0.0, 7.0, 0.2, 1.0);
		break;
	case 1:
...
void display_side() {
	...
	glTexCoord2f(0.0, 0.0);	glVertex3f(0.5, 5.0, -0.5);
	glTexCoord2f(1.0, 0.0); glVertex3f(0.5, 5.0, +0.5);
